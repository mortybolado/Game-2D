...
<style>
  ...
  .skill-tree-fire.active-skill { border-left-color: #ff4500; box-shadow: 0 0 8px rgba(255, 69, 0, 0.4); }
  .skill-tree-ice.active-skill { border-left-color: #00ccff; box-shadow: 0 0 8px rgba(0, 204, 255, 0.3); }
  .skill-tree-poison.active-skill { border-left-color: #66ff66; box-shadow: 0 0 8px rgba(102, 255, 102, 0.3); }
  .skill-tree-electric.active-skill { border-left-color: #ffff33; box-shadow: 0 0 8px rgba(255, 255, 51, 0.3); }
</style>
